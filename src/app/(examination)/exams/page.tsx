      ...
      <div className="bg-white rounded-b-xl border-x border-b border-gray-100 overflow-hidden mb-8">
        {papers.length === 0 ? (
          <div className="text-center py-16 text-gray-400">
            ...
            <div className="text-sm">No exam papers available yet.</div>
            <div className="text-xs mt-1">Admin needs to import papers via the JSON importer.</div>
          </div>
        ) : (
          papers.map((paper) => {
              ...
              >
                ...
                {hasCompleted ? (
                  <div className="text-right flex-shrink-0">
                    ...
                    <button
                      onClick={(e) => { e.stopPropagation(); router.push(`/exams/${paper.id}`) }}
