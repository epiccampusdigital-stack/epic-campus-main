...
export default function MealIngredientList({
  ...
  return (
    <div className="space-y-4">
      <label className="block text-sm font-semibold text-[#0D1B2A] dark:text-white">
            ...
            {item && (
              <div className="mt-3 space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="flex-1 font-medium text-[#0B3D6B] dark:text-white">
                    {item.itemName}
                  </span>
                  <button
                    type="button"
                    onClick={() => removeRow(index)}
                    className="flex h-11 w-11 items-center justify-center rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="h-12 flex-1 rounded-xl border border-[#DDE3EC] bg-white text-center text-lg font-semibold dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                  />
                  <span className="w-12 text-center text-sm font-medium text-gray-600 dark:text-gray-400">
                    {item.unit}
                  </span>
                  <button
                    type="button"
