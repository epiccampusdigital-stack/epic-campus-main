...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Expenses', href: '/expenses', icon: 'ti-cash-banknote', roles: ['admin', 'owner', 'accountant'] },
  ...
  { label: 'Account Activation', href: '/admin/account-activation', icon: 'ti-lock-access', roles: ['admin', 'owner', 'teacher', 'reception'] },
  ...
  { label: 'Epic Wall', href: '/admin/epic-wall', icon: 'ti-layout-cards', roles: ['admin', 'owner'] },
  ...
  {
    label: 'Japanese Online',
    href: '/japanese-online',
    icon: 'ti-language-hiragana',
    roles: ['admin', 'owner', 'teacher', 'accountant', 'reception'],
  },
]
